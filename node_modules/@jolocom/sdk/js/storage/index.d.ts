...
export declare type CredentialQuery = CredentialQueryAttrs | CredentialQueryAttrs[];
...
export declare type InteractionTokenQuery = InteractionTokenQueryAttrs | InteractionTokenQueryAttrs[];
...
export declare type InteractionQuery = InteractionQueryAttrs | InteractionQueryAttrs[];
export interface IStorageGet {
    ...
    interactionTokens(query?: InteractionTokenQuery, options?: QueryOptions): Promise<Array<JSONWebToken<any>>>;
    interactionIds(query?: InteractionQuery, options?: QueryOptions): Promise<Array<string>>;
}
