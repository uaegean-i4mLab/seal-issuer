    ...
    RegistryContract.prototype.broadcastTransaction = function (tx, sig) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.provider.sendTransaction(ethers_1.utils.serializeTransaction(ethers_1.utils.parseTransaction(tx), sig)).then(function (tx) { return tx.wait(); })];
            });
        });
    };
    /**
    ...
    RegistryContract.prototype.sendRawTransaction = function (txData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.provider.sendTransaction(ethers_1.utils.serializeTransaction(txData.unsignedTx, txData.signature)).then(function (res) { return res.wait(); })];
            });
        });
    };
