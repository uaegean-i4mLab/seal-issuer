...
exports.getRegistrar = exports.jolocomIpfsHost = exports.jolocomContract = exports.infura = void 0;
var registry_contract_1 = __importDefault(require("@jolocom/registry-contract"));
var ipfs_1 = require("./ipfs");
var JOLOCOM_PUBLIC_PROFILE_TYPE = "JolocomPublicProfile";
exports.infura = 'https://rinkeby.infura.io/v3/64fa85ca0b28483ea90919a83630d5d8';
exports.jolocomContract = '0xd4351c3f383d79ba378ed1875275b1e7b960f120';
exports.jolocomIpfsHost = 'https://ipfs.jolocom.com:443';
/**
 ...
 */
function getRegistrar(providerUrl, contractAddress, ipfsHost) {
    var _this = this;
    if (providerUrl === void 0) { providerUrl = exports.infura; }
    if (contractAddress === void 0) { contractAddress = exports.jolocomContract; }
    if (ipfsHost === void 0) { ipfsHost = exports.jolocomIpfsHost; }
    ...
    return {
         ...
         */
        publishDidDocument: function (pubKey, didDocument) { return __awaiter(_this, void 0, void 0, function () {
            var documentHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, registryContract.prepareAnchoringTransaction(didDocument.id, documentHash, pubKey)
         ...
         */
        broadcastTransaction: function (transactionHex, signature) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
         ...
         */
        publishPublicProfile: function (did, publicProfile) { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b;
...
exports.getRegistrar = getRegistrar;
/**
 * @internal
