...
exports.getPublicProfile = exports.getResolver = void 0;
var registry_contract_1 = __importDefault(require("@jolocom/registry-contract"));
var ipfs_1 = require("./ipfs");
var CONTRACT_ADDRESS = '0xd4351c3f383d79ba378ed1875275b1e7b960f120';
var PROVIDER_URI = 'https://rinkeby.infura.io/v3/64fa85ca0b28483ea90919a83630d5d8';
var IPFS_ENDPOINT = 'https://ipfs.jolocom.com:443';
/**
...
function getResolver(providerUri, contractAddress, ipfsHost) {
    if (providerUri === void 0) { providerUri = PROVIDER_URI; }
    if (contractAddress === void 0) { contractAddress = CONTRACT_ADDRESS; }
    if (ipfsHost === void 0) { ipfsHost = IPFS_ENDPOINT; }
...
function getPublicProfile(didDoc, ipfsHost) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            publicProfileSection = (_a = didDoc === null || didDoc === void 0 ? void 0 : didDoc.service) === null || _a === void 0 ? void 0 : _a.find(function (endpoint) { return endpoint.type === 'JolocomPublicProfile'; });
